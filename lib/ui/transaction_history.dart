...
class _TransactionHistoryState extends State<TransactionHistory> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: MainAppBar(
            "Transaction history", false, () => Get.back(id: widget.navId)),
        body: SizedBox(
...
class _ListTileHistoryState extends State<ListTileHistory> {
  ...
  Widget build(BuildContext context) {
    String formattedDate = DateFormat('dd/MM/yyyy')
        .format((DateTime.tryParse(widget.allData[index].timeStamp.toString())!));
          ...
          child: Row(
            ...
            children: [
              SizedBox(
                  ...
                  child: Text(
                    widget.allData[index].paymentAmount.toString(),
                    maxLines: 2,
